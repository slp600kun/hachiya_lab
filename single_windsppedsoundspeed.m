...
%% グラフデータ
f1=figure(1);
set(f1,'Position', [700 300 500 500])

f2=figure(2);
set(f2,'Position', [700 400 500 500])
...
%% 凡例
tiledlayout(2,1)
str1=' 1 \leftrightarrow 9 ';
str2=' 2 \leftrightarrow 10 ';
str3=' 3 \leftrightarrow 11 ';
str4=' 4 \leftrightarrow 12 ';
str5=' 5 \leftrightarrow 13 ';
str6=' 6 \leftrightarrow 14 ';
str7=' 7 \leftrightarrow 15 ';
str8=' 8 \leftrightarrow 16 ';
...
for ix=1:8
    ...
    pt.tp(ix,i)=xtime(fix(pt.tppos(ix,i)-0.18*192));
   ...
   %% 反対側
    ...
    pt.tm(ix,i)=xtime(fix(pt.tmpos(ix,i)-0.18*192));
end
