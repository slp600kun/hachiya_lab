...
title1="通常時の経路間波形伝搬時間と振幅(直交経路)";
title2="通常時の経路間波形伝搬時間と振幅(風に沿う経路)";
title3="扇風機設置時の経路間波形伝搬時間と振幅(直交経路)";
title4="扇風機設置時の経路間波形伝搬時間と振幅(風に沿う経路)";
...
legend([p1 p2 p3 p4],strA,'Location','northeast');
